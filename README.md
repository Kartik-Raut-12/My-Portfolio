...
Yes, you can fork this repo. Feel free to use the code for your own portfolio! Thanks!
...
## 📄 License
This project is open source and available under the [MIT License](https://github.com/Kartik-Raut-12/portfolio-2.0/blob/main/LICENSE).
