export const GENERAL_INFO = {
    ...
    email: 'kartikraut169@gmail.com',
    phone: '+91-9765761312',
    location: 'Nagpur, Maharashtra',
    emailSubject: "Let's collaborate on a project",
    emailBody: 'Hi Kartik, I am reaching out to you because...',
    resumeUrl: 'https://drive.google.com/file/d/1I1Mss80Izxf5Za4iVDNhLDklw9RJ0a8f/view?usp=drive_link',
};

export const SOCIAL_LINKS = [
    { name: 'github', url: 'https://github.com/Kartik-Raut-12' },
    { name: 'linkedin', url: 'https://linkedin.com/in/kartik-raut-4a1057270' },
];
